  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header user={user} building={selectedBuilding} buildings={syndicData.buildings} selectedBuildingId={selectedBuildingId} setSelectedBuildingId={setSelectedBuildingId} />
